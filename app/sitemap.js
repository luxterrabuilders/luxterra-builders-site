...
const routes = [
  ...
  { path: "/about", lastModified: "2026-09-03", priority: 0.8, changeFrequency: "monthly" },
  { path: "/process", lastModified: "2026-09-02", priority: 0.8, changeFrequency: "monthly" },
  { path: "/custom-home-builder-san-antonio", lastModified: "2026-09-08", priority: 0.9, changeFrequency: "monthly" },
  { path: "/build-on-your-lot", lastModified: "2026-09-03", priority: 0.9, changeFrequency: "monthly" },
  { path: "/design-build-contractor-san-antonio", lastModified: "2026-09-03", priority: 0.9, changeFrequency: "monthly" },
  { path: "/adu-builder-san-antonio", lastModified: "2026-09-08", priority: 0.9, changeFrequency: "monthly" },
  ...
  { path: "/projects/dignowity-hill-historic-renovation", lastModified: "2026-09-03", priority: 0.8, changeFrequency: "yearly" },
  { path: "/projects/kings-modern-residence", lastModified: "2026-09-08", priority: 0.7, changeFrequency: "yearly" },
  { path: "/projects/burnet-home", lastModified: "2026-09-08", priority: 0.7, changeFrequency: "yearly" },
